...
snakeh.src = 'img/snakeh.png';

const snakeb = new Image();
snakeb.src = 'img/snakeb.png';

const pointss = new Image();
pointss.src = "img/point.png";
...
const eatSound = new sound('audio/EatSound.wav');
const dieSound = new sound('audio/DieSound.wav');
...
function drawGame() {
    ...
    ctx.drawImage(pointss, food.x, food.y);
